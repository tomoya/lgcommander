...
## Supported models:
Lg has released two android apps in Google Play app store; each with a list of supported models. One for 2012 models and the other for some earlier models. If your tv is not on those lists, these scripts may not work for you.
